...
from AIpro.data import load_train_data, load_test_data
from AIpro.augmentation import flip_axis,random_zoom,random_rotation,random_channel_shift
...
def preprocess(imgs, to_rows=None, to_cols=None):
    if to_rows is None or to_cols is None:     #ggggggggggggg
        to_rows = img_rows
        to_cols = img_cols
...
def train_and_predict():
    ...
    print('Fitting model...')
    print('-'*30)
    model.fit(imgs_train, imgs_mask_train, batch_size=64, nb_epoch=20, verbose=1, shuffle=True,    #64
